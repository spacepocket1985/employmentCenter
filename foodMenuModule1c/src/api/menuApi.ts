...
export const MenuMainEndpoint = 'food-menu';
export const WeekMenuEndpoint = 'full-week'

import { TFoodMenuPeriodResponse } from 'src/types/foodMenu.types';
import {
  ApiResponse,
  MenuStatus,
  UploadResult,
...
async function request<T = unknown>(
  ...
  const url = `${BaseUrl}/${MenuMainEndpoint}/${endpoint}`;
...
export async function getMenu(): Promise<ApiResponse<TFoodMenuPeriodResponse>> {
  return request<TFoodMenuPeriodResponse>(WeekMenuEndpoint);
}
